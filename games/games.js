...
newGame('./gameFiles/1v1lol.jpeg', '1v1lol')
...
newGame('./gameFiles/Soundboard.jpg', 'Soundboard')
...
newGame('./gameFiles/MotoX3M.png', 'MotoX3M')
newGame('./gameFiles/Pokemon Ruby.png', 'Pokemon Ruby')
newGame('./gameFiles/Fireboy & Water Girl.png', 'Fireboy & Water Girl')
newGame('./gameFiles/Papas Scooperia.jpg', 'Papas Scooperia')
newGame('./gameFiles/Papas Pizzeria.png', 'Papas Pizzeria')
newGame('./gameFiles/Papas Burgeria.png', 'Papas Burgeria')
newGame('./gameFiles/Papas Sushiria.png', 'Papas Sushiria')
newGame('./gameFiles/Papas Pastaria.png', 'Papas Pastaria')
newGame('./gameFiles/Papas Donuteria.png','Papas Donuteria')
newGame('./gameFiles/Papas Cupcakeria.png', 'Papas Cupcakeria')
newGame('./gameFiles/Papas Pancakeria.png', 'Papas Pancakeria')
newGame('./gameFiles/Papas Hot Doggeria.png', 'Papas Hot Doggeria')
newGame('./gameFiles/Papas Freezeria.png', 'Papas Freezeria')
newGame('./gameFiles/Fancade.jpg', 'Fancade')

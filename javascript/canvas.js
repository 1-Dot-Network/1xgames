...
var Star = /** @class */ (function () {
    function Star(container) {
        ...
        this.FORWARD_SPEED = 550;
        this.SIDEWAYS_SPEED = 110;
        if (IS_HIGH_RES_AND_MOBILE) {
            this.FORWARD_SPEED *= 2.1;
            this.SIDEWAYS_SPEED *= 2.1;
        }
        this.container = container;
        this.x = randRange(-size, (size + (size * 0.1)));
        this.y = randRange(-size, (size + (size * 0.1)));
        ...
        this.pz = this.z;
        // colors
        this.colorArrColorWhite = Math.floor(Math.random() * 255).toString()
        this.colorArr = ["rgb(" + this.colorArrColorWhite + ", " + this.colorArrColorWhite + ", " + this.colorArrColorWhite + ")", "rgb(" + this.colorArrColorWhite + ", " + this.colorArrColorWhite + ", 255)"]
...
if (localStorage.getItem('background') !== 'off') window.onload = setup(); else {
    return
}